...
**Описание**
Домашнее задание по уроку "Тестирование" унивеситета Sky Pro.
На момент составления данного документа программа содержит 3 модуля на тему обработка данных пользователей в банковской сфере.
