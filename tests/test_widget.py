...
@pytest.mark.parametrize("name_numbers, expected", [('Visa-Classic №254652398565478',
                         ('Visa Classic', 'Введён некорректный номер карты')),
...
@pytest.mark.parametrize("full_date_time, expected",
